...
const Blog = () => {
  return (
    ...
    <div className='margen'>
        ...
        <strong className='display-6 mt-3'> 
      ...
      <div className="container md mt-4">
        <div className="row">
          <div className="col-4">
            ...
            <p><Link to="https://www.fedegan.org.co/noticias/una-vaca-por-la-paz-continua-convocando-la-solidaridad-colombiana" className="link-opacity-100-hover">Ir al articulo completo</Link></p>

          </div>
          <div className="col-4">
            <strong className='h3'>Red de Innovación en Ganadería Sostenible de Cundinamarca</strong>
            <p>El propósito de la investigación fue Incrementar el uso del conocimiento técnico - 
            ...
            <p><Link to="https://www.fedegan.org.co/red-de-innovacion-en-ganaderia-sostenible-de-cundinamarca" className="link-opacity-100-hover">Conoce la investigación aquí</Link></p>
